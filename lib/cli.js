...
const yargs = require('yargs')
  ...
  .middleware((argv) => {
    ...
    argv.username = process.env.DW_USERNAME || instance.username;
    argv.password = process.env.DW_PASSWORD || instance.password;
    argv.hostname = process.env.DW_HOSTNAME || instance.hostname;
    argv.webdav = process.env.DW_WEBDAV || instance.webdav;
    argv.key = process.env.DW_KEY || instance.key;
    argv.cert = process.env.DW_CERT || instance.cert;
    argv.ca = process.env.DW_CA || instance.ca;
