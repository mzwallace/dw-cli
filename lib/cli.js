...
.command('log <instance>', 'Stream log files from an instance', {
  ...
  'number-lines': {alias: 'options.numberLines', describe: 'Number of lines to print on each tail', default: null},
  ...
  'message-filter': {alias: 'options.messageFilter', describe: 'Filter a log message by regexp', default: null}
})
