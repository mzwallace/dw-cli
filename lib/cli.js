...
.option('log-poll-interval', {describe: 'Polling interval for log (Seconds)', default: 1})
.option('log-message-length', {describe: 'Length to truncate a log message', default: null})
.option('log-message-filter', {describe: 'Filter a log message by text', default: null})
.demand(1)
.help()
.version()
.argv;
