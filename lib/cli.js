...
.command('log <instance>', 'Stream log files from an instance', {
  'poll-interval': {alias: 'options.pollInterval', describe: 'Polling interval for log (Seconds)', default: 1},
  'number-lines': {alias: 'options.numberLines', describe: 'Number of lines to print on each tail', default: 10},
  'level-filter': {alias: 'options.levelFilter', describe: 'Error level to filter by', type: 'array', default: []},
  'message-length': {alias: 'options.messageLength', describe: 'Length to truncate a log message', default: null},
  'message-filter': {alias: 'options.messageFilter', describe: 'Filter a log message by text', default: null}
})
